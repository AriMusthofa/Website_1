<?php
    ...
    echo "<br><button><a href='msteri4.php' Materi 4 : Database</a></button>";
    echo "<br><button><a href='msteri5.php' Materi 5 : </a></button>";
    echo "<br><button><a href='msteri6.php' Materi 6 : </a></button>";
    echo "<br><button><a href='msteri7.php' Materi 7 : </a></button>";
    echo "<br><button><a href='msteri8.php' Materi 8 : </a></button>";
    echo "<br><button><a href='msteri9.php' Materi 9 : </a></button>";
    echo "<br><button><a href='msteri10.php' Materi 10 : </a></button>";
?>